-- Batch rebuild all derived tables after bulk import
...
SELECT DISTINCT ON (r.athlete_id, m.season_year)
    ...
    MIN(r.normalized_time_cs) OVER (PARTITION BY r.athlete_id, m.season_year) as season_best_normalized_time_cs,
