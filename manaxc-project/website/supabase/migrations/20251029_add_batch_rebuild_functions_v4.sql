-- Fixed version v4: Added WHERE clause to DELETE statements (Supabase requirement)
...
-- =============================================================================
-- 2. Batch rebuild athlete best times (FIXED - matches actual schema)
-- =============================================================================
...
BEGIN
  -- First, get season bests with all required fields
...
BEGIN
  -- Clear and rebuild (WHERE true required by Supabase)
